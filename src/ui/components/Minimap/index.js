...
export function initMinimap({ mount, sceneManager, characterManager, remotePlayerManager, botManager, projectileManager, arenaManager, collisionManager, entityManager }) {
