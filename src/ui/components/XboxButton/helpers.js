...
const CONTROLLER_CONFIG = {
  ...
  playstation: {
    ...
    buttons: {
      A: { label: 'Cross', modifier: 'cross', title: 'Cross' },
      B: { label: 'Circle', modifier: 'circle', title: 'Circle' },
      X: { label: 'Square', modifier: 'square', title: 'Square' },
      Y: { label: 'Triangle', modifier: 'triangle', title: 'Triangle' },
